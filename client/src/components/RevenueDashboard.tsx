...
export const RevenueDashboard = ({ onClose }: RevenueDashboardProps) => {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
        <div className="bg-gray-900 p-8 rounded-2xl text-center">
          ...
          <p className="text-white text-lg">Loading Revenue Dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 w-full max-w-7xl max-h-[90vh] rounded-2xl overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-orange-500 to-pink-500 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-orange-100 mt-1">Comprehensive financial overview and analytics</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="glass-card p-6 rounded-2xl">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full p-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors">
